...
لینک ویدئوی حل مثال های مربوط به شرط ها:
 [![06 - بررسی تعدادی مثال از شرط ها در سی پلاس پلاس](Step-6-Thumbnail.png)](https://youtu.be/6kNwKMDmyBo?si=NfpwUfKdUDG2yScO)

لینک ویدئوی پیاده سازی بازی سنگ کاغذ قیچی با استفاده از شرط ها در سی پلاس پلاس :
[![07 - ساختن بازی سنگ کاغذ قیچی در سی پلاس پلاس (مبحث شرط ها)](Step-7-Thumbnail.png)](https://www.youtube.com/watch?v=GUeiZlnMBzE)

لینک ویدئوی توضیحات مربوط به Switch Case در سی پلاس پلاس : <br>
[![08 - آشنایی با سوییچ کیس (Switch Case) در سی پلاس پلاس](Step-8-Thumbnail.png)](https://www.youtube.com/watch?v=VyQqBftqU0E)

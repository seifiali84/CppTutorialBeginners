...
[![15 - کار کردن با string ها در سی پلاس پلاس (بخش اول)](Step-15-Thumbnail.png)](https://www.youtube.com/watch?v=5GAkN2iZUOE)

ویدئوی مربوط به کار کردن با string ها (بخش دوم) : <br>
[![16 -کار کردن با string ها در سی پلاس پلاس (بخش دوم)](Step-16-Thumbnail.png)](https://www.youtube.com/watch?v=hoe7a1D3Too)
...
[![17 - معرفی حلقه ی for-each در سی پلاس پلاس - تبدیل متن به عدد و Split کردن داده ی متنی](Step-17-Thumbnail.png)](https://www.youtube.com/watch?v=OxUMZ5Ua3HE)

ویدئوی مربوط به آرایه های چند بعدی : <br>
[![18 - بررسی آرایه های چند بعدی(Multi-Dimensional Arrays) در سی پلاس پلاس](Step-18-Thumbnail.png)](https://www.youtube.com/watch?v=uFQVhWtm3Dk)
